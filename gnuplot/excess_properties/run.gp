...
plot \
  ...
  for [i=1:1] for [j=1:2] CSMO.DES[i]."-".PARAM.".out" skip 1 u 0:(5.9-0.6*j-2.2*(i-1)):(0):4:(5.9-0.6*j-2.2*(i-1)-0.1):(5.9-0.6*j-2.2*(i-1)+0.1) every 1::j::j w boxxy lw LW lc rgb COLORS[2] ,\
  ...
  for [i=1:3] for [j=0:2] CSMO.DES[i]."-".PARAM.".out" skip 1 u 3:(5.9-0.6*j-2.2*(i-1)) every 1::j::j pt 13 ps 2.5 lc -1 ,\
  for [i=1:3] for [j=0:2] CSMO.DES[i]."-".PARAM.".out" skip 1 u 3:(5.9-0.6*j-2.2*(i-1)) every 1::j::j pt 13 ps PS lc rgb COLORS[5]
unset term
unset output
replot
