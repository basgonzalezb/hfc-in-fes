...
s_title = ""
# X axis title
s_xtitle = "[C1r\\_O1o] Distance / pm"
# Y axis title
s_ytitle = "[C1r\\_H1r]-[C1r\\_O1o] Angle / Degree"
...
splot "cdf_2_rdf[C1r_O1o]_adf[C1r_H1r]-[C1r_O1o].gp.csv" matrix using ($2*10+5):($1*1.8+0.9):3
...
set output "cdf_2_rdf[C1r_O1o]_adf[C1r_H1r]-[C1r_O1o].png"
...
splot "cdf_2_rdf[C1r_O1o]_adf[C1r_H1r]-[C1r_O1o].gp.csv" matrix using ($2*10+5):($1*1.8+0.9):(f_plot($3))
...
splot "cdf_2_rdf[C1r_O1o]_adf[C1r_H1r]-[C1r_O1o].gp.csv" matrix using ($2*10+5):($1*1.8+0.9):(s_contour ? f_plot($3) : 1/0) with lines linewidth 0.15*s_contourscale linecolor rgbcolor "black" nosurface
...
set output "cdf_2_rdf[C1r_O1o]_adf[C1r_H1r]-[C1r_O1o]_box.png"
