...
mkdir -p $HOME/results/${system}
echo Total-Energy | gmx_mpi energy -f eq2.edr -s eq2.tpr -b 2000 -o $HOME/results/${system}/energy.xvg >> energy.log 2>&1
echo Pressure | gmx_mpi energy -f eq2.edr -s eq2.tpr -b 2000 -o $HOME/results/${system}/pressure.xvg >> pressure.log 2>&1
echo Volume | gmx_mpi energy -f eq2.edr -s eq2.tpr -b 2000 -o $HOME/results/${system}/volume.xvg >> volume.log 2>&1
echo Density | gmx_mpi energy -f eq2.edr -s eq2.tpr -b 2000 -o $HOME/results/${system}/density.xvg >> density.log 2>&1
cd $SYSTEM
