	...
	conda deactivate
        ...
        for temp in 303 323 343
            do
                ...
                grep "Pressure" 3_energy.log  >> $HOME/results_fit/pressure_fs_${fsigma}_and_fe_${feps}_${temp}.log 2>&1
                grep "T-System" 3_energy.log  >> $HOME/results_fit/temperature_fs_${fsigma}_and_fe_${feps}_${temp}.log 2>&1
                grep "Density" 3_energy.log  >> $HOME/results_fit/density_fs_${fsigma}_and_fe_${feps}_${temp}.log 2>&1
                grep "Total-Energy" 3_energy.log  >> $HOME/results_fit/energy_fs_${fsigma}_and_fe_${feps}_${temp}.log 2>&1
            done
    done
